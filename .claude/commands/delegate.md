...
allowed-tools: Bash(bash collab/ask.sh:*), Bash(COLLAB_CONFIRMED=1 bash collab/ask.sh:*), Bash(git diff:*), Bash(git status:*), Read, Edit, Bash(COLLAB_COMMAND=/delegate bash collab/ask.sh:*), Bash(COLLAB_COMMAND=/delegate COLLAB_CONFIRMED=1 bash collab/ask.sh:*)
---
