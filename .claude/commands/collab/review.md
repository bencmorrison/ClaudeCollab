...
allowed-tools: Bash(bash collab/ask.sh:*), Bash(COLLAB_CONFIRMED=1 bash collab/ask.sh:*), Bash(git diff:*), Bash(git status:*), Bash(git log:*), Bash(opencode models:*), Read, Grep, Glob, Bash(COLLAB_COMMAND=/collab:review bash collab/ask.sh:*), Bash(COLLAB_COMMAND=/collab:review COLLAB_CONFIRMED=1 bash collab/ask.sh:*)
---
